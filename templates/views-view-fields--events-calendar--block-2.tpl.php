...
?>
<div class="col-lg-4 col-sm-6 col-xs-12 event-cube" id="<?php print $fields['nid']->raw; ?>">
        ...
        <?php if (!empty($fields['title'])): ?>
            <h5>
                <?php if (!empty($fields['field_date'])): ?>
                    <?php print $fields['field_date']->raw; ?> | 
                <?php endif; ?>
        ...
        <a href="/node/<?php if (!empty($fields['nid'])):
           print $fields['nid']->raw; 
            ...
            <h4>
                ...
                <?php endif; ?>
                <?php if (!empty($fields['field_date_1'])): ?>
                    <small><?php print $fields['field_date_1']->content; ?></small>
                <?php endif; ?>
            </h4>
        </a>
        <?php if (!empty($fields['field_host_id'])): ?>
            <small>Via <?php print $fields['field_host_id']->content; ?></small>
        <?php endif; ?>
    </div>
</div>
